    ...
    if (state.theme.eventsCalendar && state.theme.eventsCalendar.length > 0) {
      if (range === "opposite") {
        const output = state.theme.eventsCalendar.map((event) => {
          if (
            (event.categories[0] &&
              event.categories.every((cat) => !category.includes(cat.name))) ||
            !event.categories[0]
          ) {
            return (
              <>
                <EventListItem>
                  <a target="_blank" href={event.url}>
                    <EventListDate>
                      {dayjs(`${event.start_date}`).format("M/D")} -{" "}
                    </EventListDate>
                    {myunescape(event.title)}
                  </a>
                </EventListItem>
              </>
            );
        ...
        const output = state.theme.eventsCalendar.map((event) => {
          if (
            event.categories[0] &&
            event.categories.some((cat) => cat.name.includes(category))
          ) {
            return (
              <>
                <EventListItem>
      ...
      case "membership":
        return (
          <Column
            ...
            className={
              state.theme.expandedMenu === "membership" ? "expanded" : ""
            }
          >
            <MenuContainer
              className={
                state.theme.expandedMenu === "membership"
                  ? "expanded bordered"
                  : "bordered"
              }
            >
              ...
              <MembershipItemsContainer>
                <ItemList>
                  <ItemTitle onClick={preventBubble} link="/membership">
                    Membership
                  </ItemTitle>
                  <HorizontalLine />
                  <ListItem onClick={preventBubble} link="/save-money">
                    Save Money
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/resources">
                    Resources
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/peer-groups">
                    Peer Groups
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/general-contractors">
                    General Contractors
                  </ListItem>
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/facility-rental">
                    Facility Rental
                  </ListItem>
                  <br />
                  <br />
      ...
      case "events":
        return (
          ...
          >
            <MenuContainer
              className={
                state.theme.expandedMenu === "events"
                  ? "expanded bordered"
                  : "bordered"
              }
            >
              ...
              <EventsItemsContainer>
                <ItemList>
                  <ItemTitle onClick={preventBubble} link="/events">
                    Events
                  </ItemTitle>
                  <HorizontalLine />
                  <ListItem onClick={preventBubble} link="/signature-events">
                    Signature Events
                  </ListItem>
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/pro-sponsorship">
                    PRO Sponsorship
                  </ListItem>
                  <br />
                  <br />
      ...
      case "management":
        return (
          <Column
            ...
            className={
              state.theme.expandedMenu === "management" ? "expanded large" : ""
            }
          >
            <MenuContainer
              className={
                state.theme.expandedMenu === "management"
                  ? "expanded bordered"
                  : "bordered"
              }
            >
              ...
              <ManagementItemsContainer>
                <ItemList>
                  ...
                  <HorizontalLine />
                  <ListItem onClick={preventBubble} link="/apprenticeship">
                    Apprenticeship
                  </ListItem>
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/craft-courses">
                    Craft Courses
                  </ListItem>
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/pdp">
                  ...
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/customized-training">
                    Customized Training
                  </ListItem>
                  <br />
                  <br />
      ...
      case "safety":
        return (
          ...
          >
            <MenuContainer
              className={
                state.theme.expandedMenu === "safety"
                  ? "expanded bordered"
                  : "bordered"
              }
            >
              ...
              <SafetyItemsContainer>
                <ItemList>
                  <ItemTitle onClick={preventBubble} link="/safety">
                    Safety
                  </ItemTitle>
                  <HorizontalLine />
                  <ListItem onClick={preventBubble} link="/site-inspections">
                    Site Inspections
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/safety-peer-group">
                    Safety Peer Group
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/new-hire">
                    New Hire Safety Orientation
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/step">
                    STEP
                  </ListItem>
                  <br />
                  <br />
      ...
      case "political":
        return (
          <Column
            ...
            className={
              state.theme.expandedMenu === "political" ? "expanded" : ""
            }
          >
            <MenuContainer
              className={
                state.theme.expandedMenu === "political"
                  ? "expanded bordered"
                  : "bordered"
              }
            >
              ...
              <PoliticalItemsContainer>
                <ItemList>
                  <ItemTitle onClick={preventBubble} link="/political-advocacy">
                    Political
                    <Break /> Advocacy
                  </ItemTitle>
                  <HorizontalLine />
      ...
      case "members":
        return (
          ...
          >
            <MenuContainer
              className={
                state.theme.expandedMenu === "members" ? "expanded" : ""
              }
            >
              <GrowContainer>
              ...
              <MembersItemsContainer>
                <ItemList>
                  <ItemTitle onClick={preventBubble} link="/members">
                    Members
                    <Break /> Only
                  </ItemTitle>
                  <HorizontalLine />
                  <ListItem onClick={preventBubble} link="/virtual-hr">
                    Virtual HR
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/find-a-contractor">
                    Find a Contractor
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/personal-coaching">
                    Personal Business Coaching
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/pay-invoice">
                    Pay an Invoice
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/other-resources">
                    Other Member Resource
                  </ListItem>
                  <br />
                  <br />
                  <ListItem onClick={preventBubble} link="/about-us">
                    About Us
                  </ListItem>
                  <br />
                  <br />
                  {state.theme.token ? (
                    <ListItem link="#" onClick={() => handleLogout()}>
                      Logout
                    </ListItem>
                  ) : (
                    <ListItem onClick={preventBubble} link="/login">
                      Member Login
                    </ListItem>
                  )}
                </ItemList>
        ...
        <>
          ...
          <DescriptionContainer>
            <Description>
              ...
              <strong>largest organization in Maryland</strong> to represent the
              commercial construction industry.
              <br />
              Our 650 members represent the leading general contractors and
          ...
          <QuoteContainer>
            <QuoteBlurContainer>
              <QuoteCarousel
                quoteArray={quotes}
                heading="What the Industry is Saying About ABC Baltimore"
              />
            </QuoteBlurContainer>
          </QuoteContainer>
          <InfoWrapper>
            <h2>
              <strong>ABC by the Numbers</strong>
            </h2>
            <InfographicContainer>
              <InfoColumnLeft>
                <img
