        ...
        <SectionWrapper>
          ...
          {state.theme.newsItem === "videos" ? (
            <VideosContainer>
              ...
              state.theme.youTubePosts.items.length > 0 ? (
                        ...
                        <BlogTile>
                          <div>
                            {items.featured_image_urls ? (
                              <img
                                src={items.featured_image_urls.large[0]}
                                alt=""
                              />
                            ) : null}
                          </div>
