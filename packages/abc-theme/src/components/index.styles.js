    ...
    styles={css`
      ...
      *::after {
      ...
      html {
        ...
        --shadow-elevation-low-local:
          0.5px 0.5px 0.8px hsl(var(--shadow-color) / 0.12),
          0.9px 0.9px 1.4px -1.2px hsl(var(--shadow-color) / 0.12),
          2.2px 2.2px 3.5px -2.5px hsl(var(--shadow-color) / 0.12);
        --shadow-elevation-medium-local:
          0.5px 0.5px 0.8px hsl(var(--shadow-color) / 0.13),
      ...
      .glass-dark{
        ...
        background: linear-gradient(90deg, hsla(0,0%,7%,0.3) 0%, hsla(0,0%,10%,0.6) 100%) !important;
        -webkit-backdrop-filter: blur( 25.0px );
        backdrop-filter: blur( 25.0px );
        border-radius: 10px;
        border: 1px solid hsla( 0, 0%, 100%, 0.18 );
      ...
      .ugb-number-box__content, .ugb-card__content{
        h4, p{
